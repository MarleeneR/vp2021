        ...
        if(isset($_POST["user_data_submit"])){
			...
			if(isset($_POST["surname_input"]) and !empty($_POST["surname_input"])){
				...
				if($birth_day < 1 or $birth_day > 31){
					$birth_day_error = "Palun märgi oma sünni päev!";
					}
				} else {
					$birth_day_error = "Palun märgi oma sünni päev!";
				}
				...
				if($birth_month <1 or $birth_month >12){
					$birth_month_error = "Palun märgi oma sünni kuu!";
					}
				} else {
					$birth_month_error = "Palun märgi oma sünni kuu!";
				}
				...
				if($birth_year < date("Y") - 110 or $birth_year > date("Y") - 13){
					$birth_year_error = "Palun märgi oma sünni aasta!";
					}
				} else {
					$birth_year_error = "Palun märgi oma sünni aaasta!";
				}
				...
				if($_POST["confirm_password_input"] != $_POST["password_input"]){
					...
					$confirm_password_error = "Palun sisesta oma parool kaks korda!";
				}
